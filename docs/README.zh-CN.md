...
适用于 **Windows** 🔹 Nvidia GPU 的 **ComfyUI** 一键便携安装程序  
...
| 🔧 组件 | 📝 说明 |
|---|---|
| [Git](https://git-scm.com/) | ![Git version](https://img.shields.io/github/v/tag/git/git?label=&display_name=tag&color=blue) - 最新（如有需要将安装/更新） |
| [Python](https://www.python.org/downloads/release/python-31210/) | ![Python version](https://img.shields.io/badge/3.12.10-blue) - 嵌入版本 |
| [ComfyUI](https://github.com/Comfy-Org/ComfyUI) | ![ComfyUI version](https://img.shields.io/github/v/release/Comfy-Org/ComfyUI?label=&display_name=tag) - 最新版本 |
...
## 🖥️ Windows 安装
1. [**下载 ComfyUI-Easy-Install**](https://github.com/Tavris1/ComfyUI-Easy-Install/releases/latest/download/ComfyUI-Easy-Install.zip)
...
3. 安装完成后，你可以从 **Add-ons** 文件夹安装或运行以下组件：
    ...
    - **Nunchaku** - *安装 Nunchaku（如果之后出现问题，请再次运行 `Nunchaku.bat`）*
    - **SageAttention-Multi** - *安装 SageAttention v2.2.0 和 v3（v3 仅在 NVIDIA 50 系列 GPU 上有效）*
...
> - 避免文件夹名称中包含空格或特殊字符。
> - 请确保 NVIDIA 驱动程序是最新版本。

> [!TIP]
> - 可以同时安装多个 ComfyUI，不会发生冲突。
> - 安装后可以重命名或移动 `ComfyUI-Easy-Install` 文件夹。
> - [**macOS / Linux 点击这里**](https://github.com/Tavris1/ComfyUI-Easy-Install/tree/MAC-Linux)
