...
[![Downloads](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/Tavris1/ComfyUI-Easy-Install/Windows/.github/badges/downloads.json)](https://github.com/Tavris1/ComfyUI-Easy-Install/releases)
  ...
  <p align="center">
    ...
    <a href="#support-development">❤️ Apoyar el desarrollo</a>
  </p>
...
****ComfyUI-Easy-Install** proporciona un entorno portátil de ComfyUI con **EZi Desktop**.  
...
1. [**📥 DESCARGAR ÚLTIMA VERSIÓN**](https://github.com/Tavris1/ComfyUI-Easy-Install/releases/latest/download/ComfyUI-Easy-Install.zip)
2. Extrae el ZIP en una carpeta nueva y ejecuta **`ComfyUI-Easy-Install.bat`**
