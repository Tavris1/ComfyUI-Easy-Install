...
1. Download **ComfyUI-Easy-Install** with **Nunchaku** [:arrow_forward:HERE](https://github.com/Tavris1/ComfyUI-Easy-Install/releases/download/ComfyUI-Nunchaku/ComfyUI-Nunchaku.zip)  
