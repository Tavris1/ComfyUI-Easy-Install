...
- :small_orange_diamond: **Easy-model2GGUF** *(**Add-Ons/Tools**)*
  ...
  - *For example, **flux1-dev.safetensors** (23 GB) [🔗](https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/flux1-dev.safetensors?download=true) converts to **flux1-dev-Q4_K_M.gguf** (6.5 GB) in **5 min.***
