...
.\python_embeded\python.exe -m pip install https://github.com/mit-han-lab/nunchaku/releases/download/v0.3.2dev20250701/nunchaku-0.3.2.dev20250701+torch2.7-cp311-cp311-win_amd64.whl
